...
const Github = ({darkMode}) => {
  ...
  return (
    <>
        ...
        >
          <div className=''>
            <h3 className={`${darkMode ? 'text-orange-300' : 'text-purple-300'} mb-4 font-semibold text-lg`}>Days I Code</h3>
            <GitHubCalendar
              username='mansidhamne'
              blockSize={12}
              blockMargin={2.5}
              fontSize={8}
              theme={darkMode ? { dark: ["#fff7ed", "#ffedd5", "#fed7aa", "#fdba74", "#fb923c"] } : 
            ...
            <div className='flex flex-col gap-6'>
              <div className='flex flex-row gap-10 justify-between'>
                <div className='flex flex-col justify-between items-center gap-2'>
                  <img src={avatarURL} alt="avatar" className={`rounded-full w-20 h-20 border-2 ${darkMode ? 'border-orange-300' :'border-purple-300'}`}/>
              ...
              <div className='flex flex-row justify-between gap-6'>
                <a href="https://github.com/mansidhamne/portfolio_mansi" target='_blank'>
                  <button className={`${darkMode ? 'bg-orange-400 hover:text-orange-300' : 'bg-purple-400 hover:text-purple-400'} text-white flex flex-row px-4 sm:px-8 py-2 rounded-lg gap-2 hover:cursor-pointer hover:bg-transparent`}><CgGitFork size={20}/><FaStar size={19}/></button>
                </a>
                <a href="https://github.com/mansidhamne" target='_blank'>
                  <button className={`text-white ${darkMode ? 'bg-orange-400 hover:text-orange-300' : 'bg-purple-400 hover:text-purple-400'}  px-8 py-1 rounded-lg hover:cursor-pointer hover:bg-transparent`}>Follow Me!</button>
                </a>
              </div>
            </div>
          </div>
